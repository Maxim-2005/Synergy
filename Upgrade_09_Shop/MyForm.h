...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Ëàâêà Îëèâàíäåðà 2.0";
			...
			this->comboBox1->Text = L"Ðóêîÿòü";
			this->comboBox1->SelectedIndexChanged += gcnew System::EventHandler(this, &MyForm::comboBox1_SelectedIndexChanged);
			this->comboBox1->DataSource = shaft;
			// 
			// comboBox2
			// 
			...
			this->comboBox2->Text = L"Ñåðäöåâèíà";
			this->comboBox2->SelectedIndexChanged += gcnew System::EventHandler(this, &MyForm::comboBox2_SelectedIndexChanged);
			this->comboBox2->DataSource = core;
			...
			this->groupBox1->Text = L"Âàðèàíò 1";
			// 
			// label3
			// 
			...
			this->label2->Text = L"âûáåðèòå ðóêîÿòü è ñåðäöåâèíó";
			...
			this->groupBox2->Text = L"Âàðèàíò 2";
			// 
			// label6
			// 
			...
			this->label6->Text = L"âûáèðèòå âàðèàíò";
			...
			this->button2->Text = L"Ìàêñèìàëüíàÿ öåíà";
			...
			this->label4->Text = L"âûáåðèòå ðóêîÿòü è ñåðäöåâèíó";
			...
			this->button1->Text = L"Ìèíèìàëüíàÿ öåíà";
			...
			this->groupBox3->Text = L"Âàðèàíò 3";
			// 
			// button3
			// 
			...
			this->button3->Text = L"Ñëó÷àéíûé ïîñîõ";
			...
			this->label7->Text = L"âûáåðèòå ðóêîÿòü è ñåðäöåâèíó";
...
#pragma endregion
	...
	private: System::Void comboBox1_SelectedIndexChanged(System::Object^ sender, System::EventArgs^ e) {
		...
		this->label3->Text = System::Convert::ToString(selectShaft.Value + selectCore.Value + " ãàëëåîíîâ");
	}
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		minStaff = KeyValuePair<String^, int>(L"Îñòðîëèñò + Æèëû èç êðûëà ëåòó÷åé ìûøè", 1 + 1);
		this->label4->Text = System::Convert::ToString(minStaff.Key);
		this->label5->Text = System::Convert::ToString(minStaff.Value + " ãàëëåîíîâ");
		this->label6->Text = L"Ñàìûé äåøåâûé ïîñîõ";
	}
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		maxStaff = KeyValuePair<String^, int>(L"ßâîð (áåëûé êë¸í) + Çóá âàñèëèñêà", 11 + 8);
		this->label4->Text = System::Convert::ToString(maxStaff.Key);
		this->label5->Text = System::Convert::ToString(maxStaff.Value + " ãàëëåîíîâ");
		this->label6->Text = L"Ñàìûé äîðîãîé ïîñîõ";
	}
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		this->label8->Text = System::Convert::ToString(randShaft.Value + randCore.Value + " ãàëëåîíîâ");
	}
	};
}